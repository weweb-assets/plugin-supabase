...
export default {
    ...
    computed: {
        ...
        disabled() {
            return {
                count: !this.modifiers.select && !this.noSelect,
                order: !this.modifiers.select && !this.noSelect,
                limit:
                    (!this.modifiers.select && !this.noSelect) || this.modifiers.single || this.modifiers.maybeSingle,
                range:
                    (!this.modifiers.select && !this.noSelect) || this.modifiers.single || this.modifiers.maybeSingle,
                single:
                    (!this.modifiers.select && !this.noSelect) ||
                ...
                maybeSingle:
                    ...
                    this.modifiers.limit ||
                    this.modifiers.range,
                csv: !this.modifiers.select && !this.noSelect,
            };
        },
    },
    methods: {
